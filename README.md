...
<kbd>Spring 01: Conversor de Moedas
</h4>
...
* Desenvolver um Conversor de Moedas que ofereça interação textual (via console) com os usuários. A taxa de conversão não será estática, mas sim dinamicamente obtida por meio de uma API, garantindo dados precisos e em tempo real para uma experiência mais atualizada e eficaz.
